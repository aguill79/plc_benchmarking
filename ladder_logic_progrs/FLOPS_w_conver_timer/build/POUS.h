...
typedef struct {
  ...
  __DECLARE_VAR(REAL,ELAPSED_TIME)
  __DECLARE_VAR(TIME,TRACKED_TIME)
  __DECLARE_VAR(INT,COUNT)
  __DECLARE_VAR(INT,NUM_OPS)
  __DECLARE_VAR(INT,CONVERTED_RESULT)
  ...
  __DECLARE_VAR(INT,_TMP_REAL_TO_INT34_OUT)
  __DECLARE_VAR(REAL,_TMP_TIME_TO_REAL39_OUT)
