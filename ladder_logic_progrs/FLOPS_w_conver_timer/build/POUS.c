...
static inline INT __FLOPS_SUB__INT__INT__INT1(BOOL EN,
  INT IN1,
  INT IN2,
  FLOPS *data__)
{
...
static inline BOOL __FLOPS_GT__BOOL__REAL2(BOOL EN,
  UINT __PARAM_COUNT,
  REAL IN1,
  REAL IN2,
  FLOPS *data__)
...
static inline REAL __FLOPS_MOVE__REAL__REAL3(BOOL EN,
  REAL IN,
  FLOPS *data__)
{
  REAL __res;
...
static inline BOOL __FLOPS_LE__BOOL__INT4(BOOL EN,
  UINT __PARAM_COUNT,
  INT IN1,
  INT IN2,
  FLOPS *data__)
...
static inline INT __FLOPS_MOVE__INT__INT5(BOOL EN,
  INT IN,
  FLOPS *data__)
{
  INT __res;
...
static inline REAL __FLOPS_MUL__REAL__REAL6(BOOL EN,
  UINT __PARAM_COUNT,
  REAL IN1,
  REAL IN2,
  FLOPS *data__)
...
void FLOPS_init__(FLOPS *data__, BOOL retain) {
  ...
  __INIT_VAR(data__->ELAPSED_TIME,0.0,retain)
  __INIT_VAR(data__->TRACKED_TIME,__time_to_timespec(1, 0, 200, 0, 0, 0),retain)
  __INIT_VAR(data__->COUNT,0,retain)
  __INIT_VAR(data__->NUM_OPS,200,retain)
  __INIT_VAR(data__->CONVERTED_RESULT,200,retain)
  ...
  __INIT_VAR(data__->_TMP_REAL_TO_INT34_OUT,0,retain)
  __INIT_VAR(data__->_TMP_TIME_TO_REAL39_OUT,0,retain)
}
...
void FLOPS_body__(FLOPS *data__) {
  ...
  __SET_VAR(data__->,_TMP_SUB7_OUT,,__FLOPS_SUB__INT__INT__INT1(
  ...
  __SET_VAR(data__->,_TMP_GT12_OUT,,__FLOPS_GT__BOOL__REAL2(
    (BOOL)__GET_VAR(data__->RUN_FLAG,),
    (UINT)2,
    (REAL)__GET_VAR(data__->PRODUCT,),
    (REAL)5000.0,
    data__));
  __SET_VAR(data__->,_TMP_MOVE15_OUT,,__FLOPS_MOVE__REAL__REAL3(
  ...
  __SET_VAR(data__->,_TMP_LE18_OUT,,__FLOPS_LE__BOOL__INT4(
    (BOOL)__GET_VAR(data__->RUN_FLAG,),
    (UINT)2,
    (INT)__GET_VAR(data__->COUNT,),
    (INT)1,
  ...
  __SET_VAR(data__->,_TMP_MOVE28_OUT,,__FLOPS_MOVE__INT__INT5(
  ...
  __SET_VAR(data__->,_TMP_MUL2_OUT,,__FLOPS_MUL__REAL__REAL6(
    (BOOL)__GET_VAR(data__->RUN_FLAG,),
    (UINT)2,
    (REAL)__GET_VAR(data__->PRODUCT,),
    (REAL)5.0,
  ...
  __SET_VAR(data__->,_TMP_REAL_TO_INT34_OUT,,REAL_TO_INT(
    (BOOL)__BOOL_LITERAL(TRUE),
    NULL,
    (REAL)__GET_VAR(data__->PRODUCT,)));
  __SET_VAR(data__->,CONVERTED_RESULT,,__GET_VAR(data__->_TMP_REAL_TO_INT34_OUT,));
  __SET_VAR(data__->TON0.,IN,,__BOOL_LITERAL(TRUE));
  __SET_VAR(data__->TON0.,PT,,__GET_VAR(data__->TRACKED_TIME,));
  TON_body__(&data__->TON0);
  __SET_VAR(data__->,_TMP_TIME_TO_REAL39_OUT,,TIME_TO_REAL(
    (BOOL)__BOOL_LITERAL(TRUE),
    NULL,
    (TIME)__GET_VAR(data__->TON0.ET,)));
  __SET_VAR(data__->,ELAPSED_TIME,,__GET_VAR(data__->_TMP_TIME_TO_REAL39_OUT,));
