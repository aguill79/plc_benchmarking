...
typedef struct {
  ...
  __DECLARE_VAR(BOOL,RECORD_TIME)
  RTC RTC0;
  RTC RTC1;
  ...
  __DECLARE_VAR(LREAL,_TMP_DT_TO_LREAL37_OUT)
  __DECLARE_VAR(LREAL,_TMP_DT_TO_LREAL39_OUT)
  __DECLARE_VAR(LREAL,_TMP_SUB36_OUT)
  __DECLARE_VAR(BOOL,_TMP_MOVE42_ENO)
  __DECLARE_VAR(BOOL,_TMP_MOVE42_OUT)
