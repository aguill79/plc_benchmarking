...
void MM_FB_body__(MM_FB *data__) {
  ...
  __SET_VAR(data__->,I,,0);
  {
    ...
    while( __GET_VAR(data__->I,) < (__GET_VAR(data__->N,) - 1) ) {
      if(__do_increment){
        /* BY ... (of FOR loop) */
      ...
      {
        int __do_increment = 0;
        while( __GET_VAR(data__->J,) < (__GET_VAR(data__->N,) - 1) ) {
          if(__do_increment){
            /* BY ... (of FOR loop) */
          ...
          {
            int __do_increment = 0;
            while( __GET_VAR(data__->K,) < (__GET_VAR(data__->N,) - 1) ) {
              if(__do_increment){
                /* BY ... (of FOR loop) */
  ...
  if ((__GET_VAR(data__->I,) >= (__GET_VAR(data__->N,) - 1))) {
    ...
    {
      int __do_increment = 0;
      while( __GET_VAR(data__->J,) < ((__GET_VAR(data__->N,) * __GET_VAR(data__->N,)) - 1) ) {
        if(__do_increment){
          /* BY ... (of FOR loop) */
          __SET_VAR(data__->,J,,(__GET_VAR(data__->J,) + 1));
        } else __do_increment = 1;
        __SET_VAR(data__->,CHECK_SUM,,(__GET_VAR(data__->CHECK_SUM,) + __GET_VAR(data__->M2,.table[(__GET_VAR(data__->J,)) - (0)])));
      }
    } /* END_FOR */;
  };
